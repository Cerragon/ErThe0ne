...
//wpm
constexpr auto OFFSET_CHARGEN = 0x05B1F9A0UL;//1.3.2.10 +
...
constexpr auto OFFSET_REDIRECTION_JMP = 0x017F4F4DUL;//1.3.2.10 +
...
constexpr auto OFFSET_SERVER_POSITION = 0x01469D25UL;//1.3.2.10 +
constexpr auto OFFSET_CHAR_CONTROLLER = 0x05D6E120UL;//1.3.2.10
constexpr auto OFFSET_NOCLIP_A = 0x02975798UL;//1.3.2.10 +
constexpr auto OFFSET_NOCLIP_B = 0x02975750UL;//1.3.2.10 +
constexpr auto OFFSET_NOCLIP_C = 0x015F9441UL;//1.3.2.10 +
constexpr auto OFFSET_NOCLIP_D = 0x015F9471UL;//1.3.2.10 +
...
constexpr auto VTABLE_CREATEPROJECTILEMESSAGECLIENT = 0x03AA4650UL;//1.3.2.10
