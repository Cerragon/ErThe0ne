...
//just rpm
constexpr auto OFFSET_LOCAL_PLAYER = 0x05C44CB8UL;//1.3.3.31
constexpr auto OFFSET_ENTITY_LIST = 0x5A1CAF8UL;//1.3.3.31
constexpr auto OFFSET_MAIN = 0x05CA43A8UL;//1.3.3.31
constexpr auto OFFSET_CAMERA = 0x06C4D5D0UL;//1.3.3.31 
constexpr auto OFFSET_GET_PTR_A1 = 0x05A241B8UL;//1.3.3.31
constexpr auto OFFSET_GET_PTR_A2 = 0x03D8DCF0UL;//1.3.3.31
constexpr auto OFFSET_NUKE_CODE = 0x05B5D9C8UL;//1.3.3.31
constexpr auto OFFSET_MAIN_WORLDSPACE = 0x05B5C480UL;//1.3.3.31
...
//dmg redirection
constexpr auto OFFSET_REDIRECTION = 0x01885E5BUL;//1.3.3.31
constexpr auto OFFSET_REDIRECTION_JMP = 0x01885CEDUL;//1.3.3.31

constexpr auto OFFSET_MESSAGE_SENDER = 0x0150C2D0UL;//1.3.3.31
...
//opk
constexpr auto OFFSET_OPK = 0x02A1FC7DUL;//1.3.3.31

//infinite AP
constexpr auto OFFSET_AV_REGEN = 0x0170CE0FUL;//1.3.3.31

//position spoofing
constexpr auto OFFSET_SERVER_POSITION = 0x014F7A95UL;//1.3.3.31
...
//weapon editor
constexpr auto OFFSET_DATA_HANDLER = 0x05A18328UL;//1.3.3.31

//vtables
constexpr auto VTABLE_REQUESTACTIVATEREFMSG = 0x03BCD470UL;//1.3.3.31 
constexpr auto VTABLE_REQUESTTRANSFERITEMMSG = 0x03BE1A18UL;//1.3.3.31 
constexpr auto VTABLE_REQUESTTELEPORTTOLOCATIONMSG = 0x03BD5750UL;//1.3.3.31 
