...
constexpr auto OFFSET_ENTITY_LIST = 0x52BB8B8UL;//1.4.0.23
constexpr auto OFFSET_MAIN = 0x05549AF0UL;//1.4.0.23
constexpr auto OFFSET_CAMERA = 0x0558CB40UL;//1.4.0.23
...
constexpr auto OFFSET_NOCLIP_A = 0x02A63698UL;//1.4.0.23
constexpr auto OFFSET_NOCLIP_B = 0x02A6364DUL;//1.4.0.23
...
constexpr auto VTABLE_REQUESTTRANSFERITEMMSG = 0x03C50FB8UL;//1.4.0.23
constexpr auto VTABLE_REQUESTTELEPORTTOLOCATIONMSG = 0x03C44B60UL;//1.4.0.23
constexpr auto VTABLE_CLIENTSTATEMSG = 0x03C44740UL;//1.4.0.23
constexpr auto VTABLE_REQUESTHITSONACTORS = 0x03C3C2F0UL;//1.4.0.23
