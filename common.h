...
//just rpm
constexpr auto OFFSET_LOCAL_PLAYER = 0x054C2258UL;//1.4.0.20
constexpr auto OFFSET_ENTITY_LIST = 0x5297C68UL;//1.4.0.20
constexpr auto OFFSET_MAIN = 0x055249B0UL;//1.4.0.20
constexpr auto OFFSET_CAMERA = 0x05567A10UL;//1.4.0.20
constexpr auto OFFSET_GET_PTR_A1 = 0x0529E6E8UL;//1.4.0.20
constexpr auto OFFSET_GET_PTR_A2 = 0x03DE3B40UL;//1.4.0.20
constexpr auto OFFSET_NUKE_CODE = 0x053D8A58UL;//1.4.0.20
constexpr auto OFFSET_MAIN_WORLDSPACE = 0x53D7510UL;//1.4.0.20
...
//dmg redirection
constexpr auto OFFSET_REDIRECTION = 0x018B7DEBUL;//1.4.0.20
constexpr auto OFFSET_REDIRECTION_JMP = 0x018B7C7DUL;//1.4.0.20

constexpr auto OFFSET_MESSAGE_SENDER = 0x0153B740UL;//1.4.0.20
constexpr auto OFFSET_FAKE_MESSAGE = 0x014B5627UL;//1.4.0.20
//constexpr auto OFFSET_ENTITY_ID = 0x0528E280UL;//1.4.0.20

constexpr auto OFFSET_ACTOR_VALUE = 0x0173D7B0UL;//1.4.0.20
constexpr auto OFFSET_MELEE_ATTACK = 0x017475D0UL;//1.4.0.20

//opk
constexpr auto OFFSET_OPK = 0x02A5F9FDUL;//1.4.0.20

//infinite AP
constexpr auto OFFSET_AV_REGEN = 0x0173DB6FUL;//1.4.0.20

//position spoofing
constexpr auto OFFSET_SERVER_POSITION = 0x01526D85UL;//1.4.0.20

//noclip
constexpr auto OFFSET_CHAR_CONTROLLER = 0x0571A680UL;//1.4.0.20
constexpr auto OFFSET_NOCLIP_A = 0x02A51908UL;//1.4.0.20
constexpr auto OFFSET_NOCLIP_B = 0x02A518C0UL;//1.4.0.20
constexpr auto OFFSET_NOCLIP_C = 0x016BA951UL;//1.4.0.20
constexpr auto OFFSET_NOCLIP_D = 0x016BA981UL;//1.4.0.20

//infinite ammo
constexpr auto OFFSET_INFINITE_AMMO = 0x00D5C0E6UL;//1.4.0.20 0x00D5C0B0UL?

//weapon editor
constexpr auto OFFSET_DATA_HANDLER = 0x052935F0UL;//1.4.0.20

//vtables
constexpr auto VTABLE_REQUESTACTIVATEREFMSG = 0x03C206C0UL;//1.4.0.20
constexpr auto VTABLE_REQUESTTRANSFERITEMMSG = 0x03C350E8UL;//1.4.0.20
constexpr auto VTABLE_REQUESTTELEPORTTOLOCATIONMSG = 0x03C28C30UL;//1.4.0.20
constexpr auto VTABLE_CLIENTSTATEMSG = 0x03C28810UL;//1.4.0.20
constexpr auto VTABLE_REQUESTHITSONACTORS = 0x03C202F0UL;//1.4.0.20
